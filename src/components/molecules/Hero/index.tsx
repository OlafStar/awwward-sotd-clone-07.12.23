...
const Hero = () => {
  return (
    <section className={`w-full h-[100vh]`}>
      <div
        className={`relative w-full h-full px-8  pt-[85px] pb-[55px] flex flex-col justify-between ${styles.maskAnimation}`}>
        ...
        <div className='flex justify-between flex-col sm:flex-row gap-8'>
          ...
          <div className='sm:self-end'>
            <MaskText className='text-xl text-white' delay={2.6}>
              {"Explore"}
            </MaskText>
          </div>
        </div>
